/**
 * @file bi_firebase.h
 * @brief Librer�a para conectar ESP32 a Firebase Realtime Database usando ESP-IDF
 */
...
/**
 * @brief Estados de la conexi�n Firebase
 */
typedef enum {
    FIREBASE_STATE_IDLE,
    FIREBASE_STATE_INIT,
...
/**
 * @brief Estructura para almacenar datos de autenticaci�n
 */
typedef struct {
...
/**
 * @brief Estructura para configuraci�n de Firebase
 */
typedef struct {
    char *database_url;
...
/**
 * @brief Estructura principal para manejar la conexi�n Firebase
 */
typedef struct {
...
/**
 * @brief Inicializa la librer�a Firebase
 *
 * @param config Configuraci�n para la conexi�n
 * @return firebase_handle_t* Manejador de la conexi�n o NULL si falla
 */
firebase_handle_t *firebase_init(firebase_config_t *config);

/**
 * @brief Libera recursos utilizados por la librer�a
 *
 * @param handle Manejador de la conexi�n
 */
void firebase_deinit(firebase_handle_t *handle);

/**
 * @brief Autenticaci�n con email y contrase�a
 *
 * @param handle Manejador de la conexi�n
 * @param email Email de la cuenta
 * @param password Contrase�a de la cuenta
 * @return bool true si la autenticaci�n fue exitosa
 */
bool firebase_auth_with_password(firebase_handle_t *handle, const char *email, const char *password);

/**
 * @brief Autenticaci�n con token personalizado
 *
 * @param handle Manejador de la conexi�n
...
/**
 * @brief Actualiza el token de autenticaci�n
 *
 * @param handle Manejador de la conexi�n
 * @return bool true si la actualizaci�n fue exitosa
 */
bool firebase_refresh_token(firebase_handle_t *handle);

/**
 * @brief Verifica si est� autenticado
 *
 * @param handle Manejador de la conexi�n
 * @return bool true si est� autenticado y el token es v�lido
 */
bool firebase_is_authenticated(firebase_handle_t *handle);

/**
 * @brief Obtiene datos de una ruta espec�fica (GET)
 *
 * @param handle Manejador de la conexi�n
 * @param path Ruta en la base de datos
 * @param value Puntero donde se almacenar� el valor
 * @return bool true si la operaci�n fue exitosa
 */
bool firebase_get(firebase_handle_t *handle, const char *path, firebase_data_value_t *value);

/**
 * @brief Establece datos en una ruta espec�fica (PUT)
 *
 * @param handle Manejador de la conexi�n
 * @param path Ruta en la base de datos
...
/**
 * @brief Actualiza uno o m�s campos en una ruta espec�fica (PATCH)
 *
 * @param handle Manejador de la conexi�n
 * @param path Ruta en la base de datos
...
/**
 * @brief A�ade datos a una lista generando una clave �nica (POST)
 *
 * @param handle Manejador de la conexi�n
 * @param path Ruta en la base de datos
 * @param value Valor a a�adir
 * @param generated_key Buffer donde se guardar� la clave generada
 * @param key_size Tama�o del buffer para la clave
 * @return bool true si la operaci�n fue exitosa
 */
...
/**
 * @brief Elimina datos de una ruta espec�fica (DELETE)
 *
 * @param handle Manejador de la conexi�n
 * @param path Ruta en la base de datos
 * @return bool true si la operaci�n fue exitosa
...
/**
 * @brief Verifica y mantiene la autenticaci�n peri�dicamente
 *
 * @param handle Manejador de la conexi�n
 ...
 * @param limit_to_last Limitar a �ltimos N elementos
